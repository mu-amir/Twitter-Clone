<?php 
    session_start();
    $link = mysqli_connect("sdb-h.hosting.stackcp.net","cloned-twitter-313836c7de", "egc2bqv3ml", "cloned-twitter-313836c7de");
    ...
    function displayTweets($type) {
        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                // Displaying the tweet and time on the same row
